...
v002 public placeholder実行でStage 18は26.30秒だった。Kaggle hidden rerunは約200 wellsへ拡大するため、3-well固定監査を除去し、donor KD-treeをwell間で再利用するv003へ更新する。現在のactive taskはv003 package再構築とhidden rerunである。
